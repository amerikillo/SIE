...
<%
    ...
    try {
        con.conectar();
        ResultSet rset = con.consulta("select * from datos_inv_cod where id_cap_inv = '" + ((String) sesion.getAttribute("id")) + "'");
        while (rset.next()) {
            clave = rset.getString("clave");
            descrip = rset.getString("descr");
            cod_bar = rset.getString("cod_bar");
                    ...
                    <div class="panel-body">
                        ...
                        <div class="form-group">
                            <div class="form-group">
                                ...
                                <div class="col-sm-2 control-label">
                                    <input type="radio" name="origen" value="1" onKeyPress="return tabular(event, this)" disabled > SSD
                                    <input type="radio" name="origen" value="2" checked onKeyPress="return tabular(event, this)" disabled > Soriana
                                </div>                
                                <%
                                } else {
                                %>
                                <div class="col-sm-2 control-label">
                                    <input type="radio" name="origen" value="1" <% if (origen.equals("1")) {
                                        ...
                                        } %> onKeyPress="return tabular(event, this)" disabled > SSD
                                    <input type="radio" name="origen" value="2" <% if (origen.equals("2")) {
                                            out.print("checked='checked'");
                                        } %>  onkeypress="return tabular(event, this)" disabled> Soriana
                                </div>  
                                <%
                                    }
                                %>
                                ...
                                <div class="col-sm-1 control-label">
                                    <input type="radio" name="coincide" value="Si" checked onKeyPress="return tabular(event, this)" disabled> Si
                                    <input type="radio" name="coincide" value="No"  onkeypress="return tabular(event, this)" disabled> No
                                </div>
                                <%
                                } else {
                                %>
                                <div class="col-sm-1 control-label">
                                    <input type="radio" name="coincide" value="Si" <% if (coincide.equals("Si")) {
                                            out.print("checked='checked'");
                                        } %> onKeyPress="return tabular(event, this)" disabled> Si
                                    <input type="radio" name="coincide" value="No" <% if (coincide.equals("No")) {
                                            out.print("checked='checked'");
                                        } %> onKeyPress="return tabular(event, this)" disabled> No
                                </div>
                                <%
                                    }
                                %>
                        ...
                        <div class="form-group">
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <textarea class="form-control" name ="observaciones" placeholder="Observaciones" onKeyPress="return tabular(event, this)" readonly ><%=observaciones%></textarea>
                                </div>
                            </div>
                        </div>
                        <!-- En duda -->
